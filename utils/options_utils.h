...
static void setup_options(int argc, const char* argv[])
{
  desc.add_options()
    ...
    ("test_prefill", 
     boost::program_options::value<unsigned long>()->default_value(21474836480UL),
     "Prefill amount for fanout test");
    
  // Slipstore options
  desc.add_options()
    ("baseport",
     boost::program_options::value<unsigned long>()->default_value(5000),
     "Starting port number")
    ("slipchunk",
     boost::program_options::value<unsigned long>()->default_value(4194304),
     "I/O chunk size for slipstore")
    ("slipstore_servers",
     boost::program_options::value
     <unsigned long>()->default_value(ULONG_MAX),
    ...
    ("quota",
     boost::program_options::value<unsigned long>()->default_value(ULONG_MAX),
     "Maximum space to use on this machine")
    ("zmq_threads",
     boost::program_options::value<unsigned long>()->default_value(2),
    ...
    ("batch_size",
     boost::program_options::value<unsigned long>()->default_value(1),
  ...
  desc.add_options()
    ("slipbench_fsize",
     boost::program_options::value
     <unsigned long>()->default_value(4*1024*1024*1024UL),
    ...
    ("slipbench_align",
     boost::program_options::value
     <unsigned long>()->default_value(1UL),
     "Alignment for data transfers")
    ("slipbench_background_threads",
     boost::program_options::value
     <unsigned long>()->default_value(0UL),
