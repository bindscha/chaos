...
#ifndef _BP_GRAPHCHI_NEW_
#define _BP_GRAPHCHI_NEW_
  ...
  namespace belief_prop {
    namespace graphchi_new {
      ...
      belief_propagation_graphchi<F>::belief_propagation_graphchi() {
        ...
        niters = vm["belief_propagation::niters"].as < unsigned
        long > ();
      ...
      void belief_propagation_graphchi<F>::operator()() {
        ...
        if (!restored) {
          ...
          x_lib::do_init_stream<belief_propagation_graphchi<F>,
              init_edge_wrapper<F>,
              belief_edge_wrapper>
              (graph_storage, init_stream, updates0_stream);
        ...
        while (restored || (iters < niters)) {
          ...
          x_lib::do_state_iter<belief_propagation_graphchi<F> >(graph_storage);
...
// 	  }
          ...
          bpchi_pcpu::current_step = step_absorb;
          x_lib::do_stream_skip<belief_propagation_graphchi<F>,
              belief_edge_wrapper,
              belief_edge_wrapper>
              (graph_storage, updates_in_stream, ULONG_MAX, NULL, true, false);
          bpchi_pcpu::current_step = step_rescale;
          x_lib::do_state_iter<belief_propagation_graphchi<F> >(graph_storage);
          bpchi_pcpu::current_step = step_emit;
          x_lib::do_stream_skip<belief_propagation_graphchi<F>,
              belief_edge_wrapper,
              belief_edge_wrapper>
              (graph_storage, updates_in_stream, updates_out_stream, NULL, false, true);
      ...
      void belief_propagation_graphchi<F>::partition_callback
        ...
        double PHI[2][2] = {{1 - EPSILON, EPSILON},
                            {0.5,         0.5}};
